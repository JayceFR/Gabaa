...
public class Joystick {
    ...
    public Joystick(int centerPositionX, int centerPositionY, int outer_circle_radius, int inner_circle_radius, int outer_color, int inner_color){
